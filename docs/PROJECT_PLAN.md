...
- 2026-09-26: Accounts distinguishes a bank login that needs renewal from a failed sync that can be retried. A signed-in-only function returns this minimal classification without exposing Plaid credentials, cursors, or raw server errors.
